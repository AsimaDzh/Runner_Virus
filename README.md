# 👾 Runner Virus
**Runner Virus** is a prototype game in the runner genre for PC, which aims to demonstrate dynamic gameplay, visual effects and animation. 
In the project, the player controls a virus moving around the computer, where his task is to eat as many files as possible and survive.
...
Thus, the virus must consume ordinary files, while dodging antivirus files, jumping over them or avoiding attacks.
